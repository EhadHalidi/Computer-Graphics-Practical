...
gui.add(ambientLight, 'intensity').min(0).max(3).step(0.01).name('Ambient Light');
...
const recArealLight=new THREE.RectAreaLight(0x4e00ff,6,4,3)
recArealLight.position.set(-1.5,0,1.5)
scene.add(recArealLight)

const recArealLightHelper=new RectAreaLightHelper(recArealLight, 0.3)
scene.add(recArealLightHelper)
